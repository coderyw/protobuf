...
func (m *OrderedMap) SetStringMap_(val map[string]string) {
	if m != nil {
		m.StringMap = val
	}
	return
...
func (m *UnorderedMap) SetStringMap_(val map[string]string) {
	if m != nil {
		m.StringMap = val
	}
	return
...
func (m *UnorderedMap) IsNil() bool {
	return m == nil
...
func (m *MapNoMarshaler) SetStringMap_(val map[string]string) {
	if m != nil {
		m.StringMap = val
	}
	return
...
func (m *MapNoMarshaler) IsNil() bool {
	return m == nil
...
func (m *NestedOrderedMap) SetStringMap_(val map[string]string) {
	if m != nil {
		m.StringMap = val
	}
	return
...
func (m *NestedOrderedMap) SetNestedMap_(val *NestedMap1) {
	if m != nil {
		m.NestedMap = val
	}
	return
...
func (m *NestedOrderedMap) IsNil() bool {
	return m == nil
...
func (m *NestedMap1) SetNestedStringMap_(val map[string]string) {
	if m != nil {
		m.NestedStringMap = val
	}
	return
}

func (m *NestedMap1) IsNil() bool {
	return m == nil
...
func (m *NestedUnorderedMap) SetStringMap_(val map[string]string) {
	if m != nil {
		m.StringMap = val
	}
	return
...
func (m *NestedUnorderedMap) SetNestedMap_(val *NestedMap2) {
	if m != nil {
		m.NestedMap = val
	}
	return
...
func (m *NestedUnorderedMap) IsNil() bool {
	return m == nil
...
func (m *NestedMap2) SetNestedStringMap_(val map[string]string) {
	if m != nil {
		m.NestedStringMap = val
	}
	return
...
var fileDescriptor_c4c11acb40b6bc2e = []byte{
	...
	0x4f, 0xce, 0x4f, 0x49, 0x2d, 0xaa, 0x2c, 0xd7, 0x07, 0x2b, 0x4c, 0x2a, 0x4d, 0xd3, 0x4f, 0xcf,
	...
	0xe1, 0x91, 0x1c, 0x63, 0x12, 0x1b, 0xb8, 0xdc, 0x34, 0x06, 0x04, 0x00, 0x00, 0xff, 0xff, 0x22,
	0x23, 0xd3, 0xa4, 0x8f, 0x05, 0x00, 0x00,
}
...
func (m *NestedMap1) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.NestedStringMap) > 0 {
		...
		github_com_coderyw_protobuf_sortkeys.Strings(keysForNestedStringMap)
