...
func (m *CodeGenMsg) SetInt64ReqPtr_(val int64) {
	if m != nil {
		*m.Int64ReqPtr = val
	}
...
func (m *CodeGenMsg) SetInt32OptPtr_(val int32) {
	if m != nil {
		*m.Int32OptPtr = val
	}
...
func (m *CodeGenMsg) SetInt64Req_(val int64) {
	if m != nil {
		m.Int64Req = val
	}
...
func (m *CodeGenMsg) SetInt32Opt_(val int32) {
	if m != nil {
		m.Int32Opt = val
	}
...
func (m *NonCodeGenMsg) SetInt64ReqPtr_(val int64) {
	if m != nil {
		*m.Int64ReqPtr = val
	}
...
func (m *NonCodeGenMsg) SetInt32OptPtr_(val int32) {
	if m != nil {
		*m.Int32OptPtr = val
	}
...
func (m *NonCodeGenMsg) SetInt64Req_(val int64) {
	if m != nil {
		m.Int64Req = val
	}
...
func (m *NonCodeGenMsg) SetInt32Opt_(val int32) {
	if m != nil {
		m.Int32Opt = val
	}
...
func (m *NonCodeGenMsg) IsNil() bool {
	return m == nil
...
var fileDescriptor_dece653619274e1d = []byte{
	...
	,
}
...
func (m *CodeGenMsg) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.Int64ReqPtr == nil {
		return 0, github_com_coderyw_protobuf_proto.NewRequiredNotSetError("Int64ReqPtr")
	} else {
...
func (m *CodeGenMsg) Unmarshal(dAtA []byte) error {
	...
	if hasFields[0]&uint64(0x00000001) == 0 {
		return github_com_coderyw_protobuf_proto.NewRequiredNotSetError("Int64ReqPtr")
	}
	if hasFields[0]&uint64(0x00000002) == 0 {
		return github_com_coderyw_protobuf_proto.NewRequiredNotSetError("Int64Req")
	}
