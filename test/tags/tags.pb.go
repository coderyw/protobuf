...
func (m *Outside) SetField2_(val string) {
	if m != nil {
		*m.Field2 = val
	}
...
func (m *Inside) SetField1_(val string) {
	if m != nil {
		*m.Field1 = val
	}
...
var fileDescriptor_e7d9cbcae1e528f6 = []byte{
	...
	0x02, 0x00, 0x00, 0xff, 0xff, 0x14, 0xe8, 0xd0, 0xb8, 0x44, 0x01, 0x00, 0x00,
}
