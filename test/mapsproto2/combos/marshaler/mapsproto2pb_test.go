...
func BenchmarkFloatingPointProtoUnmarshal(b *testing.B) {
	...
	for i := 0; i < 10000; i++ {
		dAtA, err := github_com_coderyw_protobuf_proto.Marshal(NewPopulatedFloatingPoint(popr, false))
		if err != nil {
			panic(err)
		}
		datas[i] = dAtA
...
func BenchmarkCustomMapProtoUnmarshal(b *testing.B) {
	...
	datas := make([][]byte, 10000)
	for i := 0; i < 10000; i++ {
		dAtA, err := github_com_coderyw_protobuf_proto.Marshal(NewPopulatedCustomMap(popr, false))
		if err != nil {
			panic(err)
		}
		datas[i] = dAtA
...
func BenchmarkAllMapsProtoUnmarshal(b *testing.B) {
	...
	datas := make([][]byte, 10000)
	for i := 0; i < 10000; i++ {
		dAtA, err := github_com_coderyw_protobuf_proto.Marshal(NewPopulatedAllMaps(popr, false))
		if err != nil {
			panic(err)
		}
		datas[i] = dAtA
...
func BenchmarkAllMapsOrderedProtoUnmarshal(b *testing.B) {
	...
	datas := make([][]byte, 10000)
	for i := 0; i < 10000; i++ {
		dAtA, err := github_com_coderyw_protobuf_proto.Marshal(NewPopulatedAllMapsOrdered(popr, false))
		if err != nil {
			panic(err)
		}
		datas[i] = dAtA
