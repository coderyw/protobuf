...
func (m *PBuffMarshal) SetField1_(val []byte) {
	if m != nil {
		m.Field1 = val
	}
	return
...
func (m *PBuffMarshal) SetField2_(val int32) {
	if m != nil {
		*m.Field2 = val
	}
...
func (m *PBuffMarshal) IsNil() bool {
	return m == nil
...
func (m *PBuffMarshaler) SetField1_(val []byte) {
	if m != nil {
		m.Field1 = val
	}
	return
...
func (m *PBuffMarshaler) SetField2_(val int32) {
	if m != nil {
		*m.Field2 = val
	}
...
func (m *PBuffMarshaler) IsNil() bool {
	return m == nil
...
var fileDescriptor_12798c2215df1728 = []byte{
	...
	0x2a, 0xcb, 0xf5, 0x61, 0xf2, 0xfa, 0xe9, 0xf9, 0xe9, 0xf9, 0x60, 0x0e, 0x98, 0x05, 0xd1, 0xae,
	...
	0x88, 0x2c, 0xb3, 0x18, 0x17, 0x2c, 0x94, 0x67, 0x04, 0x04, 0x00, 0x00, 0xff, 0xff, 0xe6, 0xd0,
	0x49, 0x7c, 0xe8, 0x00, 0x00, 0x00,
}
