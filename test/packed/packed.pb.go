...
func (m *NinRepNativeUnsafe) SetField1_(val []float64) {
	if m != nil {
		m.Field1 = val
	}
	return
...
func (m *NinRepNativeUnsafe) SetField2_(val []float32) {
	if m != nil {
		m.Field2 = val
	}
	return
...
func (m *NinRepNativeUnsafe) SetField3_(val []int32) {
	if m != nil {
		m.Field3 = val
	}
	return
...
func (m *NinRepNativeUnsafe) SetField4_(val []int64) {
	if m != nil {
		m.Field4 = val
	}
	return
...
func (m *NinRepNativeUnsafe) SetField5_(val []uint32) {
	if m != nil {
		m.Field5 = val
	}
	return
...
func (m *NinRepNativeUnsafe) SetField6_(val []uint64) {
	if m != nil {
		m.Field6 = val
	}
	return
...
func (m *NinRepNativeUnsafe) SetField7_(val []int32) {
	if m != nil {
		m.Field7 = val
	}
	return
...
func (m *NinRepNativeUnsafe) SetField8_(val []int64) {
	if m != nil {
		m.Field8 = val
	}
	return
...
func (m *NinRepNativeUnsafe) SetField9_(val []uint32) {
	if m != nil {
		m.Field9 = val
	}
	return
...
func (m *NinRepNativeUnsafe) SetField10_(val []int32) {
	if m != nil {
		m.Field10 = val
	}
	return
...
func (m *NinRepNativeUnsafe) SetField11_(val []uint64) {
	if m != nil {
		m.Field11 = val
	}
	return
...
func (m *NinRepNativeUnsafe) SetField12_(val []int64) {
	if m != nil {
		m.Field12 = val
	}
	return
...
func (m *NinRepNativeUnsafe) SetField13_(val []bool) {
	if m != nil {
		m.Field13 = val
	}
	return
...
func (m *NinRepNativeUnsafe) IsNil() bool {
	return m == nil
...
func (m *NinRepPackedNativeUnsafe) SetField1_(val []float64) {
	if m != nil {
		m.Field1 = val
	}
	return
...
func (m *NinRepPackedNativeUnsafe) SetField2_(val []float32) {
	if m != nil {
		m.Field2 = val
	}
	return
...
func (m *NinRepPackedNativeUnsafe) SetField3_(val []int32) {
	if m != nil {
		m.Field3 = val
	}
	return
...
func (m *NinRepPackedNativeUnsafe) SetField4_(val []int64) {
	if m != nil {
		m.Field4 = val
	}
	return
...
func (m *NinRepPackedNativeUnsafe) SetField5_(val []uint32) {
	if m != nil {
		m.Field5 = val
	}
	return
...
func (m *NinRepPackedNativeUnsafe) SetField6_(val []uint64) {
	if m != nil {
		m.Field6 = val
	}
	return
...
func (m *NinRepPackedNativeUnsafe) SetField7_(val []int32) {
	if m != nil {
		m.Field7 = val
	}
	return
...
func (m *NinRepPackedNativeUnsafe) SetField8_(val []int64) {
	if m != nil {
		m.Field8 = val
	}
	return
...
func (m *NinRepPackedNativeUnsafe) SetField9_(val []uint32) {
	if m != nil {
		m.Field9 = val
	}
	return
...
func (m *NinRepPackedNativeUnsafe) SetField10_(val []int32) {
	if m != nil {
		m.Field10 = val
	}
	return
...
func (m *NinRepPackedNativeUnsafe) SetField11_(val []uint64) {
	if m != nil {
		m.Field11 = val
	}
	return
...
func (m *NinRepPackedNativeUnsafe) SetField12_(val []int64) {
	if m != nil {
		m.Field12 = val
	}
	return
...
func (m *NinRepPackedNativeUnsafe) SetField13_(val []bool) {
	if m != nil {
		m.Field13 = val
	}
	return
...
func (m *NinRepPackedNativeUnsafe) IsNil() bool {
	return m == nil
...
var fileDescriptor_2c9922eb15f14bbb = []byte{
	...
	,
}
