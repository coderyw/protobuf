[GoGo Protobuf looking for new ownership](https://github.com/coderyw/protobuf/issues/691)

# Protocol Buffers for Go with Gadgets

[![Build Status](https://github.com/coderyw/protobuf/workflows/Continuous%20Integration/badge.svg)](https://github.com/coderyw/protobuf/actions)
[![GoDoc](https://godoc.org/github.com/coderyw/protobuf?status.svg)](http://godoc.org/github.com/coderyw/protobuf)
...
<a href="https://github.com/coderyw/protobuf/issues/191">issue</a>

## Release v1.3.0

The project has updated to release v1.3.0. Check out the release notes <a href="https://github.com/coderyw/protobuf/releases/tag/v1.3.0">here</a>.
...
Install the protoc-gen-gofast binary
    ...
    go get github.com/coderyw/protobuf/protoc-gen-gofast

Use it to generate faster marshaling and unmarshaling go code for your protocol buffers.

    protoc --gofast_out=. myproto.proto

This does not allow you to use any of the other gogoprotobuf [extensions](https://github.com/coderyw/protobuf/blob/master/extensions.md).
...
Installing any of these binaries is easy.  Simply run:
    ...
    go get github.com/coderyw/protobuf/proto
    go get github.com/coderyw/protobuf/{binary}
    go get github.com/coderyw/protobuf/gogoproto

These binaries allow you to use gogoprotobuf [extensions](https://github.com/coderyw/protobuf/blob/master/extensions.md). You can also use your own binary.

To generate the code, you also need to set the include path properly.

    protoc -I=. -I=$GOPATH/src -I=$GOPATH/src/github.com/coderyw/protobuf/protobuf --{binary}_out=. myproto.proto

To use proto files from "google/protobuf" you need to add additional args to protoc.

    protoc -I=. -I=$GOPATH/src -I=$GOPATH/src/github.com/coderyw/protobuf/protobuf --{binary}_out=\
...
Please visit the [extensions](https://github.com/coderyw/protobuf/blob/master/extensions.md) page for more documentation.

Install protoc-gen-gogo:

    go get github.com/coderyw/protobuf/proto
    go get github.com/coderyw/protobuf/jsonpb
    go get github.com/coderyw/protobuf/protoc-gen-gogo
    go get github.com/coderyw/protobuf/gogoproto
