...
func (m *GoTestField) SetLabel_(val string) {
	if m != nil {
		*m.Label = val
	}
...
func (m *GoTestField) SetType_(val string) {
	if m != nil {
		*m.Type = val
	}
...
func (m *GoTest) SetKind_(val GoTest_KIND) {
	if m != nil {
		*m.Kind = val
	}
...
func (m *GoTest) SetTable_(val string) {
	if m != nil {
		*m.Table = val
	}
...
func (m *GoTest) SetParam_(val int32) {
	if m != nil {
		*m.Param = val
	}
...
func (m *GoTest) SetRequiredField_(val *GoTestField) {
	if m != nil {
		m.RequiredField = val
	}
	return
...
func (m *GoTest) SetRepeatedField_(val []*GoTestField) {
	if m != nil {
		m.RepeatedField = val
	}
	return
...
func (m *GoTest) SetOptionalField_(val *GoTestField) {
	if m != nil {
		m.OptionalField = val
	}
	return
...
func (m *GoTest) SetF_BoolRequired_(val bool) {
	if m != nil {
		*m.F_BoolRequired = val
	}

}

func (m *GoTest) SetF_Int32Required_(val int32) {
	if m != nil {
		*m.F_Int32Required = val
	}

}

func (m *GoTest) SetF_Int64Required_(val int64) {
	if m != nil {
		*m.F_Int64Required = val
	}

}

func (m *GoTest) SetF_Fixed32Required_(val uint32) {
	if m != nil {
		*m.F_Fixed32Required = val
	}

}

func (m *GoTest) SetF_Fixed64Required_(val uint64) {
	if m != nil {
		*m.F_Fixed64Required = val
	}

}

func (m *GoTest) SetF_Uint32Required_(val uint32) {
	if m != nil {
		*m.F_Uint32Required = val
	}

}

func (m *GoTest) SetF_Uint64Required_(val uint64) {
	if m != nil {
		*m.F_Uint64Required = val
	}

}

func (m *GoTest) SetF_FloatRequired_(val float32) {
	if m != nil {
		*m.F_FloatRequired = val
	}

}

func (m *GoTest) SetF_DoubleRequired_(val float64) {
	if m != nil {
		*m.F_DoubleRequired = val
	}

}

func (m *GoTest) SetF_StringRequired_(val string) {
	if m != nil {
		*m.F_StringRequired = val
	}

}

func (m *GoTest) SetF_BytesRequired_(val []byte) {
	if m != nil {
		m.F_BytesRequired = val
	}
	return
}

func (m *GoTest) SetF_Sint32Required_(val int32) {
	if m != nil {
		*m.F_Sint32Required = val
	}

}

func (m *GoTest) SetF_Sint64Required_(val int64) {
	if m != nil {
		*m.F_Sint64Required = val
	}

}

func (m *GoTest) SetF_Sfixed32Required_(val int32) {
	if m != nil {
		*m.F_Sfixed32Required = val
	}

}

func (m *GoTest) SetF_Sfixed64Required_(val int64) {
	if m != nil {
		*m.F_Sfixed64Required = val
	}

}

func (m *GoTest) SetF_BoolRepeated_(val []bool) {
	if m != nil {
		m.F_BoolRepeated = val
	}
	return
}

func (m *GoTest) SetF_Int32Repeated_(val []int32) {
	if m != nil {
		m.F_Int32Repeated = val
	}
	return
}

func (m *GoTest) SetF_Int64Repeated_(val []int64) {
	if m != nil {
		m.F_Int64Repeated = val
	}
	return
}

func (m *GoTest) SetF_Fixed32Repeated_(val []uint32) {
	if m != nil {
		m.F_Fixed32Repeated = val
	}
	return
}

func (m *GoTest) SetF_Fixed64Repeated_(val []uint64) {
	if m != nil {
		m.F_Fixed64Repeated = val
	}
	return
}

func (m *GoTest) SetF_Uint32Repeated_(val []uint32) {
	if m != nil {
		m.F_Uint32Repeated = val
	}
	return
}

func (m *GoTest) SetF_Uint64Repeated_(val []uint64) {
	if m != nil {
		m.F_Uint64Repeated = val
	}
	return
}

func (m *GoTest) SetF_FloatRepeated_(val []float32) {
	if m != nil {
		m.F_FloatRepeated = val
	}
	return
}

func (m *GoTest) SetF_DoubleRepeated_(val []float64) {
	if m != nil {
		m.F_DoubleRepeated = val
	}
	return
}

func (m *GoTest) SetF_StringRepeated_(val []string) {
	if m != nil {
		m.F_StringRepeated = val
	}
	return
}

func (m *GoTest) SetF_BytesRepeated_(val [][]byte) {
	if m != nil {
		m.F_BytesRepeated = val
	}
	return
}

func (m *GoTest) SetF_Sint32Repeated_(val []int32) {
	if m != nil {
		m.F_Sint32Repeated = val
	}
	return
}

func (m *GoTest) SetF_Sint64Repeated_(val []int64) {
	if m != nil {
		m.F_Sint64Repeated = val
	}
	return
}

func (m *GoTest) SetF_Sfixed32Repeated_(val []int32) {
	if m != nil {
		m.F_Sfixed32Repeated = val
	}
	return
}

func (m *GoTest) SetF_Sfixed64Repeated_(val []int64) {
	if m != nil {
		m.F_Sfixed64Repeated = val
	}
	return
}

func (m *GoTest) SetF_BoolOptional_(val bool) {
	if m != nil {
		*m.F_BoolOptional = val
	}

}

func (m *GoTest) SetF_Int32Optional_(val int32) {
	if m != nil {
		*m.F_Int32Optional = val
	}

}

func (m *GoTest) SetF_Int64Optional_(val int64) {
	if m != nil {
		*m.F_Int64Optional = val
	}

}

func (m *GoTest) SetF_Fixed32Optional_(val uint32) {
	if m != nil {
		*m.F_Fixed32Optional = val
	}

}

func (m *GoTest) SetF_Fixed64Optional_(val uint64) {
	if m != nil {
		*m.F_Fixed64Optional = val
	}

}

func (m *GoTest) SetF_Uint32Optional_(val uint32) {
	if m != nil {
		*m.F_Uint32Optional = val
	}

}

func (m *GoTest) SetF_Uint64Optional_(val uint64) {
	if m != nil {
		*m.F_Uint64Optional = val
	}

}

func (m *GoTest) SetF_FloatOptional_(val float32) {
	if m != nil {
		*m.F_FloatOptional = val
	}

}

func (m *GoTest) SetF_DoubleOptional_(val float64) {
	if m != nil {
		*m.F_DoubleOptional = val
	}

}

func (m *GoTest) SetF_StringOptional_(val string) {
	if m != nil {
		*m.F_StringOptional = val
	}

}

func (m *GoTest) SetF_BytesOptional_(val []byte) {
	if m != nil {
		m.F_BytesOptional = val
	}
	return
}

func (m *GoTest) SetF_Sint32Optional_(val int32) {
	if m != nil {
		*m.F_Sint32Optional = val
	}

}

func (m *GoTest) SetF_Sint64Optional_(val int64) {
	if m != nil {
		*m.F_Sint64Optional = val
	}

}

func (m *GoTest) SetF_Sfixed32Optional_(val int32) {
	if m != nil {
		*m.F_Sfixed32Optional = val
	}

}

func (m *GoTest) SetF_Sfixed64Optional_(val int64) {
	if m != nil {
		*m.F_Sfixed64Optional = val
	}

}

func (m *GoTest) SetF_BoolDefaulted_(val bool) {
	if m != nil {
		*m.F_BoolDefaulted = val
	}

}

func (m *GoTest) SetF_Int32Defaulted_(val int32) {
	if m != nil {
		*m.F_Int32Defaulted = val
	}

}

func (m *GoTest) SetF_Int64Defaulted_(val int64) {
	if m != nil {
		*m.F_Int64Defaulted = val
	}

}

func (m *GoTest) SetF_Fixed32Defaulted_(val uint32) {
	if m != nil {
		*m.F_Fixed32Defaulted = val
	}

}

func (m *GoTest) SetF_Fixed64Defaulted_(val uint64) {
	if m != nil {
		*m.F_Fixed64Defaulted = val
	}

}

func (m *GoTest) SetF_Uint32Defaulted_(val uint32) {
	if m != nil {
		*m.F_Uint32Defaulted = val
	}

}

func (m *GoTest) SetF_Uint64Defaulted_(val uint64) {
	if m != nil {
		*m.F_Uint64Defaulted = val
	}

}

func (m *GoTest) SetF_FloatDefaulted_(val float32) {
	if m != nil {
		*m.F_FloatDefaulted = val
	}

}

func (m *GoTest) SetF_DoubleDefaulted_(val float64) {
	if m != nil {
		*m.F_DoubleDefaulted = val
	}

}

func (m *GoTest) SetF_StringDefaulted_(val string) {
	if m != nil {
		*m.F_StringDefaulted = val
	}

}

func (m *GoTest) SetF_BytesDefaulted_(val []byte) {
	if m != nil {
		m.F_BytesDefaulted = val
	}

}

func (m *GoTest) SetF_Sint32Defaulted_(val int32) {
	if m != nil {
		*m.F_Sint32Defaulted = val
	}

}

func (m *GoTest) SetF_Sint64Defaulted_(val int64) {
	if m != nil {
		*m.F_Sint64Defaulted = val
	}

}

func (m *GoTest) SetF_Sfixed32Defaulted_(val int32) {
	if m != nil {
		*m.F_Sfixed32Defaulted = val
	}

}

func (m *GoTest) SetF_Sfixed64Defaulted_(val int64) {
	if m != nil {
		*m.F_Sfixed64Defaulted = val
	}

}

func (m *GoTest) SetF_BoolRepeatedPacked_(val []bool) {
	if m != nil {
		m.F_BoolRepeatedPacked = val
	}
	return
}

func (m *GoTest) SetF_Int32RepeatedPacked_(val []int32) {
	if m != nil {
		m.F_Int32RepeatedPacked = val
	}
	return
}

func (m *GoTest) SetF_Int64RepeatedPacked_(val []int64) {
	if m != nil {
		m.F_Int64RepeatedPacked = val
	}
	return
}

func (m *GoTest) SetF_Fixed32RepeatedPacked_(val []uint32) {
	if m != nil {
		m.F_Fixed32RepeatedPacked = val
	}
	return
}

func (m *GoTest) SetF_Fixed64RepeatedPacked_(val []uint64) {
	if m != nil {
		m.F_Fixed64RepeatedPacked = val
	}
	return
}

func (m *GoTest) SetF_Uint32RepeatedPacked_(val []uint32) {
	if m != nil {
		m.F_Uint32RepeatedPacked = val
	}
	return
}

func (m *GoTest) SetF_Uint64RepeatedPacked_(val []uint64) {
	if m != nil {
		m.F_Uint64RepeatedPacked = val
	}
	return
}

func (m *GoTest) SetF_FloatRepeatedPacked_(val []float32) {
	if m != nil {
		m.F_FloatRepeatedPacked = val
	}
	return
}

func (m *GoTest) SetF_DoubleRepeatedPacked_(val []float64) {
	if m != nil {
		m.F_DoubleRepeatedPacked = val
	}
	return
}

func (m *GoTest) SetF_Sint32RepeatedPacked_(val []int32) {
	if m != nil {
		m.F_Sint32RepeatedPacked = val
	}
	return
}

func (m *GoTest) SetF_Sint64RepeatedPacked_(val []int64) {
	if m != nil {
		m.F_Sint64RepeatedPacked = val
	}
	return
}

func (m *GoTest) SetF_Sfixed32RepeatedPacked_(val []int32) {
	if m != nil {
		m.F_Sfixed32RepeatedPacked = val
	}
	return
}

func (m *GoTest) SetF_Sfixed64RepeatedPacked_(val []int64) {
	if m != nil {
		m.F_Sfixed64RepeatedPacked = val
	}
	return
}

func (m *GoTest) SetRequiredgroup_(val *GoTest_RequiredGroup) {
	if m != nil {
		m.Requiredgroup = val
	}
	return
...
func (m *GoTest) SetRepeatedgroup_(val []*GoTest_RepeatedGroup) {
	if m != nil {
		m.Repeatedgroup = val
	}
	return
...
func (m *GoTest) SetOptionalgroup_(val *GoTest_OptionalGroup) {
	if m != nil {
		m.Optionalgroup = val
	}
	return
...
func (m *GoTest_RequiredGroup) SetRequiredField_(val string) {
	if m != nil {
		*m.RequiredField = val
	}
...
func (m *GoTest_RequiredGroup) IsNil() bool {
	return m == nil
...
func (m *GoTest_RepeatedGroup) SetRequiredField_(val string) {
	if m != nil {
		*m.RequiredField = val
	}
...
func (m *GoTest_RepeatedGroup) IsNil() bool {
	return m == nil
...
func (m *GoTest_OptionalGroup) SetRequiredField_(val string) {
	if m != nil {
		*m.RequiredField = val
	}
...
func (m *GoTest_OptionalGroup) IsNil() bool {
	return m == nil
...
func (m *GoTestRequiredGroupField) SetGroup_(val *GoTestRequiredGroupField_Group) {
	if m != nil {
		m.Group = val
	}
	return
...
func (m *GoTestRequiredGroupField) IsNil() bool {
	return m == nil
...
func (m *GoTestRequiredGroupField_Group) SetField_(val int32) {
	if m != nil {
		*m.Field = val
	}
...
func (m *GoTestRequiredGroupField_Group) IsNil() bool {
	return m == nil
...
func (m *GoSkipTest) SetSkipInt32_(val int32) {
	if m != nil {
		*m.SkipInt32 = val
	}
...
func (m *GoSkipTest) SetSkipFixed32_(val uint32) {
	if m != nil {
		*m.SkipFixed32 = val
	}
...
func (m *GoSkipTest) SetSkipFixed64_(val uint64) {
	if m != nil {
		*m.SkipFixed64 = val
	}
...
func (m *GoSkipTest) SetSkipString_(val string) {
	if m != nil {
		*m.SkipString = val
	}
...
func (m *GoSkipTest) SetSkipgroup_(val *GoSkipTest_SkipGroup) {
	if m != nil {
		m.Skipgroup = val
	}
	return
...
func (m *GoSkipTest_SkipGroup) SetGroupInt32_(val int32) {
	if m != nil {
		*m.GroupInt32 = val
	}
...
func (m *GoSkipTest_SkipGroup) SetGroupString_(val string) {
	if m != nil {
		*m.GroupString = val
	}
...
func (m *GoSkipTest_SkipGroup) IsNil() bool {
	return m == nil
...
func (m *NonPackedTest) SetA_(val []int32) {
	if m != nil {
		m.A = val
	}
	return
...
func (m *NonPackedTest) IsNil() bool {
	return m == nil
...
func (m *PackedTest) SetB_(val []int32) {
	if m != nil {
		m.B = val
	}
	return
...
func (m *MaxTag) SetLastField_(val string) {
	if m != nil {
		*m.LastField = val
	}
...
func (m *OldMessage) SetNested_(val *OldMessage_Nested) {
	if m != nil {
		m.Nested = val
	}
	return
...
func (m *OldMessage) SetNum_(val int32) {
	if m != nil {
		*m.Num = val
	}
...
func (m *OldMessage_Nested) SetName_(val string) {
	if m != nil {
		*m.Name = val
	}
...
func (m *OldMessage_Nested) IsNil() bool {
	return m == nil
...
func (m *NewMessage) SetNested_(val *NewMessage_Nested) {
	if m != nil {
		m.Nested = val
	}
	return
...
func (m *NewMessage) SetNum_(val int64) {
	if m != nil {
		*m.Num = val
	}
...
func (m *NewMessage_Nested) SetName_(val string) {
	if m != nil {
		*m.Name = val
	}
...
func (m *NewMessage_Nested) SetFoodGroup_(val string) {
	if m != nil {
		*m.FoodGroup = val
	}
...
func (m *NewMessage_Nested) IsNil() bool {
	return m == nil
...
func (m *InnerMessage) SetHost_(val string) {
	if m != nil {
		*m.Host = val
	}
...
func (m *InnerMessage) SetPort_(val int32) {
	if m != nil {
		*m.Port = val
	}
...
func (m *InnerMessage) SetConnected_(val bool) {
	if m != nil {
		*m.Connected = val
	}
...
func (m *InnerMessage) IsNil() bool {
	return m == nil
...
func (m *OtherMessage) SetKey_(val int64) {
	if m != nil {
		*m.Key = val
	}
...
func (m *OtherMessage) SetValue_(val []byte) {
	if m != nil {
		m.Value = val
	}
	return
...
func (m *OtherMessage) SetWeight_(val float32) {
	if m != nil {
		*m.Weight = val
	}
...
func (m *OtherMessage) SetInner_(val *InnerMessage) {
	if m != nil {
		m.Inner = val
	}
	return
...
func (m *OtherMessage) IsNil() bool {
	return m == nil
...
func (m *RequiredInnerMessage) SetLeoFinallyWonAnOscar_(val *InnerMessage) {
	if m != nil {
		m.LeoFinallyWonAnOscar = val
	}
	return
}

func (m *RequiredInnerMessage) IsNil() bool {
	return m == nil
...
func (m *MyMessage) SetCount_(val int32) {
	if m != nil {
		*m.Count = val
	}
...
func (m *MyMessage) SetName_(val string) {
	if m != nil {
		*m.Name = val
	}
...
func (m *MyMessage) SetQuote_(val string) {
	if m != nil {
		*m.Quote = val
	}
...
func (m *MyMessage) SetPet_(val []string) {
	if m != nil {
		m.Pet = val
	}
	return
...
func (m *MyMessage) SetInner_(val *InnerMessage) {
	if m != nil {
		m.Inner = val
	}
	return
...
func (m *MyMessage) SetOthers_(val []*OtherMessage) {
	if m != nil {
		m.Others = val
	}
	return
...
func (m *MyMessage) SetWeMustGoDeeper_(val *RequiredInnerMessage) {
	if m != nil {
		m.WeMustGoDeeper = val
	}
	return
}

func (m *MyMessage) SetRepInner_(val []*InnerMessage) {
	if m != nil {
		m.RepInner = val
	}
	return
...
func (m *MyMessage) SetBikeshed_(val MyMessage_Color) {
	if m != nil {
		*m.Bikeshed = val
	}
...
func (m *MyMessage) SetSomegroup_(val *MyMessage_SomeGroup) {
	if m != nil {
		m.Somegroup = val
	}
	return
...
func (m *MyMessage) SetRepBytes_(val [][]byte) {
	if m != nil {
		m.RepBytes = val
	}
	return
...
func (m *MyMessage) SetBigfloat_(val float64) {
	if m != nil {
		*m.Bigfloat = val
	}
...
func (m *MyMessage_SomeGroup) SetGroupField_(val int32) {
	if m != nil {
		*m.GroupField = val
	}
...
func (m *MyMessage_SomeGroup) IsNil() bool {
	return m == nil
...
func (m *Ext) SetData_(val string) {
	if m != nil {
		*m.Data = val
	}
...
func (m *Ext) SetMapField_(val map[int32]int32) {
	if m != nil {
		m.MapField = val
	}
	return
...
func (m *ComplexExtension) SetFirst_(val int32) {
	if m != nil {
		*m.First = val
	}
...
func (m *ComplexExtension) SetSecond_(val int32) {
	if m != nil {
		*m.Second = val
	}
...
func (m *ComplexExtension) SetThird_(val []int32) {
	if m != nil {
		m.Third = val
	}
	return
...
func (m *ComplexExtension) IsNil() bool {
	return m == nil
...
func (m *DefaultsMessage) IsNil() bool {
	return m == nil
...
func (m *MyMessageSet) IsNil() bool {
	return m == nil
...
func (m *MessageList) SetMessage_(val []*MessageList_Message) {
	if m != nil {
		m.Message = val
	}
	return
...
func (m *MessageList_Message) SetName_(val string) {
	if m != nil {
		*m.Name = val
	}
...
func (m *MessageList_Message) SetCount_(val int32) {
	if m != nil {
		*m.Count = val
	}
...
func (m *MessageList_Message) IsNil() bool {
	return m == nil
...
func (m *Strings) SetStringField_(val string) {
	if m != nil {
		*m.StringField = val
	}
...
func (m *Strings) SetBytesField_(val []byte) {
	if m != nil {
		m.BytesField = val
	}
	return
...
func (m *Defaults) SetF_Bool_(val bool) {
	if m != nil {
		*m.F_Bool = val
	}
...
func (m *Defaults) SetF_Int32_(val int32) {
	if m != nil {
		*m.F_Int32 = val
	}
...
func (m *Defaults) SetF_Int64_(val int64) {
	if m != nil {
		*m.F_Int64 = val
	}
...
func (m *Defaults) SetF_Fixed32_(val uint32) {
	if m != nil {
		*m.F_Fixed32 = val
	}
...
func (m *Defaults) SetF_Fixed64_(val uint64) {
	if m != nil {
		*m.F_Fixed64 = val
	}
...
func (m *Defaults) SetF_Uint32_(val uint32) {
	if m != nil {
		*m.F_Uint32 = val
	}
...
func (m *Defaults) SetF_Uint64_(val uint64) {
	if m != nil {
		*m.F_Uint64 = val
	}
...
func (m *Defaults) SetF_Float_(val float32) {
	if m != nil {
		*m.F_Float = val
	}
...
func (m *Defaults) SetF_Double_(val float64) {
	if m != nil {
		*m.F_Double = val
	}
...
func (m *Defaults) SetF_String_(val string) {
	if m != nil {
		*m.F_String = val
	}
...
func (m *Defaults) SetF_Bytes_(val []byte) {
	if m != nil {
		m.F_Bytes = val
	}
...
func (m *Defaults) SetF_Sint32_(val int32) {
	if m != nil {
		*m.F_Sint32 = val
	}
...
func (m *Defaults) SetF_Sint64_(val int64) {
	if m != nil {
		*m.F_Sint64 = val
	}
...
func (m *Defaults) SetF_Enum_(val Defaults_Color) {
	if m != nil {
		*m.F_Enum = val
	}
...
func (m *Defaults) SetF_Pinf_(val float32) {
	if m != nil {
		*m.F_Pinf = val
	}
...
func (m *Defaults) SetF_Ninf_(val float32) {
	if m != nil {
		*m.F_Ninf = val
	}
...
func (m *Defaults) SetF_Nan_(val float32) {
	if m != nil {
		*m.F_Nan = val
	}
...
func (m *Defaults) SetSub_(val *SubDefaults) {
	if m != nil {
		m.Sub = val
	}
	return
...
func (m *Defaults) SetStrZero_(val string) {
	if m != nil {
		*m.StrZero = val
	}
...
func (m *SubDefaults) SetN_(val int64) {
	if m != nil {
		*m.N = val
	}
...
func (m *RepeatedEnum) SetColor_(val []RepeatedEnum_Color) {
	if m != nil {
		m.Color = val
	}
	return
...
func (m *RepeatedEnum) IsNil() bool {
	return m == nil
...
func (m *MoreRepeated) SetBools_(val []bool) {
	if m != nil {
		m.Bools = val
	}
	return
...
func (m *MoreRepeated) SetBoolsPacked_(val []bool) {
	if m != nil {
		m.BoolsPacked = val
	}
	return
...
func (m *MoreRepeated) SetInts_(val []int32) {
	if m != nil {
		m.Ints = val
	}
	return
...
func (m *MoreRepeated) SetIntsPacked_(val []int32) {
	if m != nil {
		m.IntsPacked = val
	}
	return
...
func (m *MoreRepeated) SetInt64SPacked_(val []int64) {
	if m != nil {
		m.Int64SPacked = val
	}
	return
...
func (m *MoreRepeated) SetStrings_(val []string) {
	if m != nil {
		m.Strings = val
	}
	return
...
func (m *MoreRepeated) SetFixeds_(val []uint32) {
	if m != nil {
		m.Fixeds = val
	}
	return
...
func (m *MoreRepeated) IsNil() bool {
	return m == nil
...
func (m *GroupOld) SetG_(val *GroupOld_G) {
	if m != nil {
		m.G = val
	}
	return
...
func (m *GroupOld_G) SetX_(val int32) {
	if m != nil {
		*m.X = val
	}
...
func (m *GroupNew) SetG_(val *GroupNew_G) {
	if m != nil {
		m.G = val
	}
	return
...
func (m *GroupNew_G) SetX_(val int32) {
	if m != nil {
		*m.X = val
	}
...
func (m *GroupNew_G) SetY_(val int32) {
	if m != nil {
		*m.Y = val
	}
...
func (m *FloatingPoint) SetExact_(val bool) {
	if m != nil {
		*m.Exact = val
	}
...
func (m *MessageWithMap) SetNameMapping_(val map[int32]string) {
	if m != nil {
		m.NameMapping = val
	}
	return
...
func (m *MessageWithMap) SetMsgMapping_(val map[int64]*FloatingPoint) {
	if m != nil {
		m.MsgMapping = val
	}
	return
...
func (m *MessageWithMap) SetStrToStr_(val map[string]string) {
	if m != nil {
		m.StrToStr = val
	}
	return
...
func (m *Oneof_F_Group) SetX_(val int32) {
	if m != nil {
		*m.X = val
	}
...
func (m *Oneof_F_Group) IsNil() bool {
	return m == nil
...
var fileDescriptor_c161fcfdc0c3ff1e = []byte{
	...
	0x87, 0xb4, 0x9d, 0x55, 0x1e, 0x50, 0x20, 0x31, 0x00, 0xb1, 0x02, 0x66, 0x60, 0x60, 0xb0, 0x22,
	...
	,
	...
	,
	...
	0xc3, 0x9d, 0x68, 0xee, 0xb2, 0xae, 0xf8, 0xc2, 0xf4, 0x3c, 0xab, 0x28, 0x4c, 0x1f, 0x78, 0x05,
	0x43, 0x06, 0x17, 0xe6, 0x14, 0xb2, 0x62, 0x04, 0x48, 0x5d, 0x57, 0x02, 0x61, 0xfa, 0xc8, 0x90,
	0x30, 0x7d, 0xec, 0x55, 0x5d, 0x11, 0x85, 0x39, 0x03, 0x2d, 0x32, 0xe7, 0x75, 0x45, 0x14, 0xa6,
	...
	,
}
